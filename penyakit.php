        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="index.html" class="navbar-brand mx-4 mb-3 ">
                    <h3 class="text-primary">SPFC</h3>
                </a>
                <div class="navbar-nav w-100">
                    <a href="penyakit.php" class="nav-item nav-link active"><i class="fas fa-plus-circle me-2"></i>Data Penyakit</a>
                        ...
                        <tbody>
                            <?php while ($row = mysqli_fetch_assoc($penyakit)) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <button onclick="editPenyakit(<?php echo $row['id']; ?>, '<?php echo $row['kode']; ?>', '<?php echo $row['nama']; ?>')" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#exampleModal">Edit</button>
